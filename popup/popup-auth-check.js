...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // Never let an unexpected error leave the popup stuck invisible — reveal
        // the UI so the user at least sees the popup instead of a dead icon.
        console.error('Auth check crashed; revealing UI as a fail-safe:', error);
        document.body.style.opacity = '1';
    }
});
